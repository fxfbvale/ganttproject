...
public class ExporterToXLSX extends ExporterBase {
    ...
    private static String[] FILE_EXTENSIONS = new String[] { "xlsx" };

    @Override
    public String getFileTypeDescription() {
        return GanttLanguage.getInstance().getText("impex.xlsx.description");
    }
    ...
    protected ExporterJob[] createJobs(final File outputFile, List<File> resultFiles) {
        ExporterJob job = createXLSXExportJob(outputFile);
        resultFiles.add(outputFile);
        return new ExporterJob[] { job };
    }

    private ExporterJob createXLSXExportJob(final File outputFile) {
        ExporterJob result = new ExporterJob("Export project") {
            ...
            protected IStatus run() {
                ...
                try {
                    ...
                    GanttXLSXExport exporter = new GanttXLSXExport(getProject());
